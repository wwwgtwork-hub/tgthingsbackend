...
// TODO: confirm this is the correct path to your auth middleware module.
// It must export requireTelegramAuth, requireAdmin, isSelfOrAdmin.
const { requireTelegramAuth, requireAdmin, isSelfOrAdmin } = require("../middleware/telegramAuth.js");
